...
def tree(x0, y0, size):
    ...
    pygame.draw.ellipse(screen, blue_green, (x0 - 90 * size, y0 - 50 * size, 200 * size, 100 * size))
    pygame.draw.ellipse(screen, blue_green, (x0 - 40 * size, y0 - 100 * size, 100 * size, 150 * size))
...
def peizazh():
    pygame.draw.rect(screen, GREEN, (0, 200, 2 * 794, 1123))


def sun():
    pygame.draw.circle(screen, YELLOW, (794, 0), radius=100)
