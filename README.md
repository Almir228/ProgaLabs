...
- [Замеры сортировок](lab2/approx.py): оценка наклонов в логарифмических координатах через NumPy по готовым замерам. Анализ запускается независимо от программ C++.
...
| [lab2](lab2) | Эксперименты с шейкерной сортировкой, сортировками расчёской и Шелла на C++; графики и аппроксимация в логарифмических координатах на Python. Общие функции C++ находятся в `Function.h`. |
...
- В `lab2` присутствует общий заголовок `Function.h`; отдельная проверка сборки всех программ и корректности сортировок не проводилась. Готовые замеры и анализ доступны.
